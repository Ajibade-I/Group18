...
const Hero = () => {
  return (
    <div className="bg-covers  bg-no-repeat bg-cover h-dvh flex px-14  items-center  tablet:justify-center ">
       ...
       <p className="text-white w-[400px] py-4 tablet:w-[220px]"> Lorem ipsum dolor sit amet, Fusce rutrum nibh nec nulla eleifend, 
     ...
     <div className="my-8 flex gap-5  tablet:text-[10px]   font-medium tablet:my-0 tablet:gap-6"> 
        <button className="p-5 bg-[#00b074] text-white  rounded-md tablet:p-2">
                SEARCH A JOB
            </button>
            <button className="p-5  bg-transparent text-[#00b074] border rounded-md tablet:p-2">
                FIND A TALENT
            </button></div>
       </div>
