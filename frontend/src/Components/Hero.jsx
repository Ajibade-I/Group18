...
const Hero = () => {
  return (
    <div className="bg-covers  bg-no-repeat bg-cover h-dvh flex px-14  items-center   tablet:justify-center ">
       ...
       <h2 className=" font-extrabold  tablet:pt-14 montserrat-regular tablet:text-3xl  tablet:w-[220px] text-7xl text-white w-[850px] animate-slide-down   ">Find The Best Startup Job That Fit You</h2>
