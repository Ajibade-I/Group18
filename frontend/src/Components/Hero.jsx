...
const Hero = () => {
  return (
    <div className="bg-covers  bg-no-repeat bg-cover h-dvh flex px-14  items-center  tablet:justify-center ">
       <div> 
       <h2 className=" font-extrabold  tablet:pt-14 montserrat-regular tablet:text-3xl md:text-3xl md:w-[350px] tablet:w-[220px] text-6xl text-white w-[800px]  ">Find The Best Startup Job That Fit You</h2>
