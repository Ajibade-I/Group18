        ...
        <div className="  bg-white w-full mt-10 flex px-10   tablet:flex-col tablet:py-4 h-[200px] tablet:h-[250px] hover:border justify-between items-center ">
            <div className="flex gap-5">
                ...
                <div>
                      ...
                      <div className="flex flex-col justify-center tablet:mt-0  mt-12 md:mt-0">
                      <h3 className="font-bold  text-[18px]  text-[rgb(43,57,64)] text-left ">{props.title}</h3>
                           <div className="gap-5 tablet:gap-2 flex tablet:flex-col md:flex-col">
                                <div className=" gap-1 flex items-center" >
                                 <span className="text-[#00b074]"> {props.icon}</span>
                                 <span className="text-[12px]"> {props.text}</span>
                              </div>
            ...
            <div>
                <div className="flex gap-4 tablet:gap-14 md:gap-2">
            ...
            <div className="gap-2 flex font-medium text-[#2b3940] md:text-[12px]">
